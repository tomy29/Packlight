...
var packlightApp = angular.module('packlightApp', ['http-auth-interceptor', 'tmh.dynamicLocale',
    'ngResource', 'ngRoute', 'ngCookies', 'packlightAppUtils', 'pascalprecht.translate', 'truncate']);
