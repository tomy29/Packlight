...
@Configuration
@EnableJpaRepositories("com.breizh.packlight.repository")
...
public class DatabaseConfiguration implements EnvironmentAware {
    ...
    @ConditionalOnMissingClass(name = "com.breizh.packlight.config.HerokuDatabaseConfiguration.class")
    ...
    public List<String> getBasePackages() {
        ...
        basePackages.add("com.breizh.packlight.domain");
        return basePackages;
    }
